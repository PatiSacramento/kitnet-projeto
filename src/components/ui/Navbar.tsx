    ...
    >
      <div className="w-full md:my-auto">
        <div className="relative flex items-center justify-between">
          ...
          <Button className="hidden h-10 font-semibold md:flex">Contato</Button>
        ...
        >
          <ul className="space-y-4 font-medium">
            <li onClick={() => setOpen(false)}>
              <Link href={siteConfig.baseLinks.nossasKitnets}>Nossas kitnets</Link>
            </li>
            <li onClick={() => setOpen(false)}>
              <Link href={siteConfig.baseLinks.regiao}>A Região</Link>
            </li>
          </ul>
        </nav>
      </div>
