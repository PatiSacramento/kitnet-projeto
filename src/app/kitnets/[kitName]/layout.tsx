...
export default function Page({ params }: Params) {
  const images = [
    ...getImagesFromFolder(`images/imagens-kitnets/${params.kitName}`),
    ...getImagesFromFolder(`images/imagens-kitnets/area-comum`),
  ];
  const ContentComponent = contentMap[params.kitName].content;

  return (
    <>
      <KitnetNavigationButton kitKey={params.kitName} allKits={contentMap} />
